...
urlpatterns = [
    ...
    path("api/media/jobs/<int:job_id>/input", worker_api.worker_job_input, name="worker_job_input"),
    path("api/worker/jobs/<int:job_id>/input", worker_api.worker_job_input, name="worker_job_input_legacy"),
    path("api/worker/jobs/<int:job_id>/complete", worker_api.worker_complete_job, name="worker_complete_job"),
